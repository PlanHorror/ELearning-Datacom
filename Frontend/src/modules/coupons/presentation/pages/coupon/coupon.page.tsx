...
const CouponPage: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (coupons.length === 0) {
      return <Empty description={t("coupons.empty")} className={styles.empty} />;
    }
        ...
        <div className={styles.component_container}>
          <Tabs
            ...
            items={[
              {
                key: "all",
                label: renderTabLabel(<StarOutlined />, t("coupons.tabAll")),
              },
              {
                key: labels.find((l) => l.name === "Popular")?.id || "popular",
                label: renderTabLabel(<FireOutlined />, t("coupons.tabPopular")),
              },
              {
                key: labels.find((l) => l.name === "New")?.id || "new",
                label: renderTabLabel(<HeartOutlined />, t("coupons.tabNew")),
              },
            ]}
          />
